...
package gradle.kotlin.dsl.plugins._018052b43034b8058815af573e15a381
...
@org.gradle.api.Generated
internal
class `RuPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `ru`.
 */
internal
val `PluginDependenciesSpec`.`ru`: `RuPluginGroup`
    get() = `RuPluginGroup`(this)


/**
 * The `ru.vyarus` plugin group.
 */
@org.gradle.api.Generated
internal
class `RuVyarusPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `ru.vyarus`.
 */
internal
val `RuPluginGroup`.`vyarus`: `RuVyarusPluginGroup`
    get() = `RuVyarusPluginGroup`(plugins)


/**
 * The `ru.vyarus.animalsniffer` plugin implemented by [ru.vyarus.gradle.plugin.animalsniffer.AnimalSnifferPlugin].
 */
internal
val `RuVyarusPluginGroup`.`animalsniffer`: PluginDependencySpec
    get() = plugins.id("ru.vyarus.animalsniffer")
